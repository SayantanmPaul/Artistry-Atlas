    ...
    <>
      <div className="group flex flex-row w-full relative">
        ...
        <div className="flex flex-col gap-1 w-full items-start">
          <div className="flex items-center justify-between lg:gap-[186px] w-full gap-5">
            <p className={`${interbold.className} font-semibold md:text-xl`}>
              {data.company}
            </p>
          ...
          {data && data.description && (
            <>
              ...
              >
                <p
                  className={`group-hover:underline text-transparent bg-clip-text bg-gradient-to-r from-[#00C6FB] to-[#005BEA] font-bold text-xs ${poppinsbold.className}`}
                >
              ...
              <span
                className={`prose dark:prose-invert w-full text-sm leading-6 ${learnMore ? "open" : "closed"}`}
              >
