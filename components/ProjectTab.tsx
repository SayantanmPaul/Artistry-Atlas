...
const ProjectTab = ({
    ...
    <span className='p-[2.1px] bg-[#7FEBEE] hover:bg-gradient-to-r hover:from-[#1798FF] hover:to-[#D65DFE] lg:rounded-[7px] rounded-[10px] cursor-pointer duration-300 ease-in-out object-cover relative'>
        ...
        <span className=' w-full lg:rounded-[7px] rounded-[10px] group overflow-hidden'>
            ...
            <div className='absolute top-[2px] z-10 w-[99%] h-32 bg-gradient-to-b from-slate-900/40 overflow-hidden lg:rounded-[7px] rounded-[10px]'>
            </div>
            <div className='absolute top-[12px] left-[24px] w-auto z-10'>
                <p className={`${poppinsSemibold.className} text-white text-[12px] leading-[22px] text-nowrap`}>{ data.catagory}</p>
            </div>
            <div className='absolute h-[86px] bottom-[2px] bg-[#0F0B17]/40 w-[99%] backdrop-blur-[20px] overflow-hidden lg:rounded-b-[6px] rounded-b-[10px] lg:group-hover:block lg:hidden block duration-500 ease-out-expo'>
