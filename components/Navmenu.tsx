    ...
    return (
        <>
            <div className="mx-auto lg:max-w-[1050px] lg:max-h-[52px] justify-between items-center flex lg:px-[25px] px-[8px]  lg:py-2 py-[3px] bg-[#FFFFFF] bg-opacity-30 dark:bg-[#1D1B25] dark:bg-opacity-40 border dark:border-[#413A6F] border-[#FFFFFF] border-opacity-50 dark:border-opacity-40 rounded-[12px] duration-300 transition-all overflow-hidden">
                ...
                <ul className=' lg:flex md:flex flex-row gap-6 font-medium lg:text-[16px] md:text-[12px] text-[12px] text-[#22242C] dark:text-[#C4C4C4] duration-300 hidden '>
                ...
                <div className='flex flex-row gap-4 items-center'>
                    <Link href={'Links'}>
                        <li className={`${poppins.className} bg-clip-text text-transparent inline-block bg-gradient-to-r dark:from-[#FFC729] dark:to-[#C84E00] dark:bg-gradient-to-r from-[#FC6584] to-[#0D25B9] font-black text-sm duration-300 ease-in-out lg:hidden md:hidden`}>links</li>
                    </Link>
