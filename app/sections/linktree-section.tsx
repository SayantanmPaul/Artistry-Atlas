  ...
  return (
    <div className="flex flex-col lg:gap-[36px] gap-[28px] items-center">
      <div className="flex flex-col lg:gap-[16px] gap-[12px] items-center">
        <div className="border border-[#005BEA] rounded-full p-1">
          <Image
            ...
            priority
            draggable={false}
            className="lg:w-[130px] lg:h-[130px] w-[120px] h-[120px] rounded-full overflow-hidden"
          />
        </div>
        <h2
          className={`${Ibarra.className} text-[24px] leading-[22px] font-bold`}
        >
          Sayantan paul
        </h2>
        <p
          className={`${poppins.className} text-[12px] leading-[22px] font-normal max-w-[264px] text-center text-[#494E52] dark:text-[#C4C4C4]`}
        >
          {AboutDocs.metadescription}
        </p>
        <div className="flex flex-row gap-[24px]">
          {SocialsLogo &&
            mainSocials.map((link, i) => {
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Link href={link.link}>
                        <div
                          key={i}
                          className="p-[10px] rounded-[8px] border border-transparent hover:border-[#005BEA] ease-in-out duration-300 hover:text-[#005BEA] dark:hover:text-[#00C6FB]"
                        >
                          <IconComp size={20} />
                        </div>
                      </Link>
      ...
      <div className="flex flex-col gap-[20px]">
        <p
          className={`${raleway.className} tracking-[6px] dark:text-white/60 uppercase text-[14px] text-[#191825]/60 duration-300 ease-in-out text-center w-full`}
        >
          Featured Projects
        </p>
                  ...
                  <div className="dark:bg-[#413A6F]/20 bg-[#D0CADF] hover:bg-gradient-to-r hover:from-[#1798FF] hover:to-[#D65DFE] p-[1px] rounded-[6px] group">
                    <div className="dark:bg-[#0F0B17] bg-[#FFFFFF] rounded-[5px]">
                      <div className="flex flex-row justify-between items-center px-[22px] py-[8px]">
                        ...
                        <ImArrowUpRight2
                          size={16}
                          className="text-[#D0CADF] dark:text-[#F2F3F3]/40 group-hover:text-[#1798FF] duration-300 ease-in-out"
                        />
                      </div>
                    </div>
                  </div>
